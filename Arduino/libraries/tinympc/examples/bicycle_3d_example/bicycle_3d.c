...
//========================================
void tiny_Bicycle3dNonlinearDynamics_Raw(sfloat* xn, const sfloat* x, const sfloat* u) {
...
//========================================
void tiny_Bicycle3dGetJacobianA_Raw(sfloat* A, const sfloat* x, const sfloat* u) {
  A[0] = 1;
  A[1] = 0;
  A[2] = 0;
  A[3] = 0;
...
void tiny_Bicycle3dGetJacobianB_Raw(sfloat* B, const sfloat* x, const sfloat* u) {
  B[0] = 0.16666666666666666 * (0.4 * cos(0.05 * tan(u[1]) * u[0] + x[2]) + 0.1 * cos(0.1 * tan(u[1]) * u[0] + x[2]) + 0.1 * cos(x[2]) + -0.01 * sin(0.1 * tan(u[1]) * u[0] + x[2]) * tan(u[1]) * u[0] + -0.02 * sin(0.05 * tan(u[1]) * u[0] + x[2]) * tan(u[1]) * u[0]);
  B[1] = 0.16666666666666666 * (0.4 * sin(0.05 * tan(u[1]) * u[0] + x[2]) + 0.1 * sin(0.1 * tan(u[1]) * u[0] + x[2]) + 0.1 * sin(x[2]) + 0.02 * cos(0.05 * tan(u[1]) * u[0] + x[2]) * tan(u[1]) * u[0] + 0.01 * cos(0.1 * tan(u[1]) * u[0] + x[2]) * tan(u[1]) * u[0]);
  B[2] = 0.1 * tan(u[1]);
  B[3] = 0.16666666666666666 * (-0.01 * (1 + pow(tan(u[1]), 2)) * pow(u[0], 2) * sin(0.1 * tan(u[1]) * u[0] + x[2]) + -0.02 * (1 + pow(tan(u[1]), 2)) * pow(u[0], 2) * sin(0.05 * tan(u[1]) * u[0] + x[2]));
  B[4] = 0.16666666666666666 * (0.01 * (1 + pow(tan(u[1]), 2)) * pow(u[0], 2) * cos(0.1 * tan(u[1]) * u[0] + x[2]) + 0.02 * (1 + pow(tan(u[1]), 2)) * pow(u[0], 2) * cos(0.05 * tan(u[1]) * u[0] + x[2]));
