...
int tiny_ReadData_Extend(const char* filename, double* des, 
                        const int stride, const int size, bool verbose)
{
    FILE *input;
    int i;
    int k = 0;
...
// remaining space of the array. Useful for extend horizon at the end.
//========================================
int tiny_ReadData_ExtendGoal(const char* filename, double* des, const double* xf,
                        const int stride, const int size, bool verbose)
{
    FILE *input;
    int i;
...
//========================================
void tiny_Clamps(double* arr, const double* min, const double* max, const int N)
{
    for (int k = 0; k < N; ++k)
    {
